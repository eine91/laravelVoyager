        ...
        <div id="has-many-{{$column}}" style="margin-top: 15px;">
                ...
                @foreach($forms as $pk => $form)
                    <tr class="has-many-{{$column}}-form fields-group">
                        ...
                        @if($options['allowDelete'])
                            <td class="form-group">
                                <div>
                                    <div class="removeTable btn btn-warning btn-sm pull-right"><i class="fa fa-trash">&nbsp;</i>{{ trans('admin.remove') }}</div>
                                </div>
                            </td>
                        @endif
                    </tr>
            ...
            @if($options['allowCreate'])
                <div class="form-group">
                    <div class="{{$viewClass['field']}}">
                        <div class="addTable btn btn-success btn-sm"><i class="fa fa-save"></i>&nbsp;{{ trans('admin.new') }}</div>
                    </div>
                </div>
            @endif
        </div>
