...
<div class="row">
    <div class="{{$viewClass['label']}}"><h4 class="pull-right">@if(strtolower($label) === 'dmcrooms') Add Room(s) @elseif(strtolower($label) === 'dmcspecialrates') Add Special Rate(s) @else {{ $label }} @endif</h4></div>
