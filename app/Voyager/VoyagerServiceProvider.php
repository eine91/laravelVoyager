...
class VoyagerServiceProvider extends ServiceProvider
{
    ...
    public function boot(Router $router, Dispatcher $event)
    {
        ...
        $this->loadTranslationsFrom(realpath(dirname(__DIR__,2).'/vendor/tcg/voyager/publishable/lang'), 'voyager');
    ...
    {
        $publishablePath = dirname(__DIR__,2).'/vendor/tcg/voyager/publishable';
    ...
    public function registerConfigs()
    {
        $this->mergeConfigFrom(
            ...
            dirname(__DIR__,2).'/vendor/tcg/voyager/publishable/config/voyager.php', 'voyager'
        );
    }
